...
def parse_args(pargs=None):
    ...
    parser.add_argument('--data0', default='/home/jun/proj/bt/data/backtest/AAPL.csv',
                        required=False, help='Data0 to read in')

    parser.add_argument('--data1', default='/home/jun/proj/bt/data/backtest/SPY.csv',
                        required=False, help='Data1 to read in')

    parser.add_argument('--data2', default='/home/jun/proj/bt/data/backtest/CSCO.csv',
                        required=False, help='Data1 to read in')

    # Defaults for dates
    parser.add_argument('--fromdate', required=False, default='2010-01-01',

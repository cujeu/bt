...
def get_mywatch_symbols():
    mw_list=[ 
            #高估值成長股（可選消費行業）2022-12-6
            'TSLA', 'MCD','BKNG','MELI','CMG','HLT','ABNB','LULU','YUM','MTN','WING',
            #'RACE', 'LULU', 'MCD', 'ABNB', 'YUM', 'CHDN', 'CHH', 'PLNT', 'WING',
            #高估值成長股（軟件&服務行業）2022-11-27
            'V','MA','NOW','SNPS','FTNT','CDNS','ANSS','VRSN','FICO','PAYC','PCTY',
            #高估值成長股（半導體行業）2022-11-17
            'AVGO','NVDA','TXN','ADI','MCHP','MRVL','SEDG','FSLR','ENPH','MPWR','LSCC',
            #高估值成長股（醫療設備行業）2022-11-15
            'ISRG','RMD','IDXX','DXCM','VEEV','PODD','ABMD','SWAV','DOCS',
            #美股大空頭：那些被極度做空的股票 2022-11-16
            'BYND','CVNA','BBBY','VTNR','UPST','RVLV','RKT','W','MARA','NVAX','CHWY','SIRI','BIG','SKIN','FATE','OLPX','NOVA','FUBO','GRPN','EBIX'
            ]
    mw_list.sort()
    return mw_list
